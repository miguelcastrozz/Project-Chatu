...
const userModel = mongoose.Schema({
  ...
  "contrasenia": { type: String, required: true }, "correo": { type: String, required: true, validate: { validator: validarCorreo, message: "Volud@, me podes hacer el favor de ingresar un correo correcto" } },
